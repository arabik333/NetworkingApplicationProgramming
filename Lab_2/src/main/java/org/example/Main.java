    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (n) {
                ...
                case 2 -> {
                    library.add(createJournal());
                }
                case 3 -> {
                    library.add(createTextbook());
                }
                case 4 -> {
                ...
                case 10 -> {
                    library.filterByType(library.choose(List.of("Book", "Journal", "Textbook")));
                }
                case 11 -> {
                ...
                case 16 -> {
                    saveToFile(filename, library.getLibrary());
                }
                case 17 -> {
                    library.setLibrary(loadFromFile(filename));
                }
                case 18 -> {
                    return;
                }
